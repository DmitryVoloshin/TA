          ...
          <div className="carousel-active_gradient">
            ...
            <div className="carousel-item_info">
              ...
              <p className="carousel-info_text">
                Inquietude simplicity terminated she compliment remarkably few
                her nay. The weeks are ham asked jokes.
              </p>
              <button className="carousel-active_button">ALL SIMULATORS</button>
            </div>
          </div>
        </SwiperSlide>
